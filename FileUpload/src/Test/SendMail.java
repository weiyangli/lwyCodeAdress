...
public class SendMail {
    ...
    public static String myEmailAccount = "15510557605@163.com";
    public static String myEmailPassword = "lwy5201314";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "15754630037@163.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "中国联通", "UTF-8"));
        ...
        message.setContent("缴飞", "text/html;charset=UTF-8");
        // 6. 设置发件时间
